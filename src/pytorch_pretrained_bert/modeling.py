...
class BaseModelOutput(object):
    """
    A quite easy output class for bert output, in order to enable this Bert
    modle to be used like the Bert model in transformers
    """

    def __init__(self, last_hidden_state=None, pooled_output=None, hidden_states=None, attentions=None):
...
class BertSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, output_attentions=False):
        ...
        return (context_layer, attention_scores) if output_attentions else (context_layer,)
...
class BertAttention(nn.Module):
    ...
    def forward(self, input_tensor, attention_mask, output_attentions=False):
        self_output = self.self(input_tensor, attention_mask, output_attentions)
...
class BertEncoder(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, output_hidden_states=False, output_attentions=False):
...
class BertPreTrainedModel(nn.Module):
    ...
    def from_pretrained(cls, pretrained_model_name, state_dict=None, cache_dir=None, *inputs, **kwargs):
        ...
        # Load config
        tmp_config_file = os.path.join(serialization_dir, CONFIG_NAME)
        config_file = tmp_config_file if os.path.exists(tmp_config_file) else os.path.join(serialization_dir,
                                                                                           'bert_config.json')
        config = BertConfig.from_json_file(config_file)

        # In this version of BERT code, we cannot change the parameters in the config file when using
        # from_pretrained to get the BERT model, so we add this simple code to achieve this function
        to_remove = []
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, inputs_embeds=None,
                position_ids=None, output_hidden_states=False, output_attentions=False):
        ...
        embedding_output = self.embeddings(input_ids, token_type_ids,
                                           position_ids) if inputs_embeds is None else inputs_embeds
...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None):
        _, pooled_output = self.bert(input_ids, token_type_ids, attention_mask, output_hidden_states=False)
...
class BertForTokenClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None):
        sequence_output, _ = self.bert(input_ids, token_type_ids, attention_mask, output_hidden_states=False)
